      ...
      var date_new=[];
        ...
        window.onload=function(){
          ...
          for(i=0;i<spans.length;i++)
               {
                if(i!=2){ img_div[i].style.left=scrollWidth+"px";}
               }
            ...
            // 元气早餐切换
            var breakfastImg = ["../img/m58087ecb1bdac_59.png","../img/xidan2.png","../img/xidian3.png"];
            var tea = $("tea");
            ...
            var m=1;  
                toLeft.onclick = function(){
                   tea.style.backgroundImage = "url("+breakfastImg[m]+")";
                   m++;
                   if(m>breakfastImg.length-1){m=0;}
                }
                
               toRight.onclick = function(){ 
                   tea.style.backgroundImage = "url("+breakfastImg[m]+")";
                   m--;
                   if(m<0){m=breakfastImg.length-1;}
                }
